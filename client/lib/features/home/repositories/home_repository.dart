...
class HomeRepository {
  Future<Either<AppFailure, String>> uploadSong(
    ...
    try {
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('${ServerConstants.severUrl}/song/upload'),
      );
  ...
  Future<Either<AppFailure, List<SongModel>>> getAllSongs(
    ...
    try {
      final res = await http.get(
        Uri.parse('${ServerConstants.severUrl}/song/list'),
        headers: {
  ...
  Future<Either<AppFailure, bool>> favSongs(
    ...
    try {
      final res = await http.post(
          Uri.parse('${ServerConstants.severUrl}/song/favorite'),
          headers: {
            'Content-Type': 'application/json',
            'x-auth-token': token,
          },
  ...
  Future<Either<AppFailure, List<SongModel>>> getFavSongs(
    ...
    try {
      final res = await http.get(
        Uri.parse('${ServerConstants.severUrl}/song/list/favorites'),
        headers: {
          'Content-Type': 'application/json',
          'x-auth-token': token,
        },
